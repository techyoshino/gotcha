...
Update URI: https://fe-advanced-search.com/
...
add_filter( 'posts_join', 'feas_posts_join', 10, 2 );
...
function feas_load_admin_css() {
    wp_enqueue_style( 'feas_admin', plugin_dir_url( __FILE__ ) . 'admin/admin.css' );
}

function feas_load_admin_js() {
    wp_enqueue_script( 'feas_admin', plugin_dir_url( __FILE__ ) . 'admin/admin.js' );
	wp_enqueue_script( 'sortablejs', plugin_dir_url( __FILE__ ) . 'admin/Sortable.min.js', array(), false, false );
}
...
$cols = array(
	...
	37 => 'feadvns_family_select_',
	38 => 'feadvns_is_acf_multiple_',
	39 => 'feadvns_default_value_',
);
...
// 検索フォームのスタイル
$feadvns_form_style = 'feadvns_form_style';
$feadvns_form_apply_style = 'feadvns_form_apply_style_';
...
// リセットボタン
$feadvns_reset_btn_sw = "feadvns_reset_btn_sw_";
$feadvns_reset_btn_js = "feadvns_reset_btn_js_";
$feadvns_reset_btn_position = "feadvns_reset_btn_position_";
$feadvns_reset_btn_text = "feadvns_reset_btn_text_";
...
// 投稿タイプ毎にソート
$feadvns_sort_by_posttype = 'feadvns_sort_by_posttype_';
...
function feas_pre_set_site_transient_update_plugins( $transient ) {
	...
	// fe-advanced-search/fe-advanced-search.php
    ...
    if ( false !== $response ) {
        ...
        $item = (object) array(
            'id'            => 'fe-advanced-search/fe-advanced-search.php',
            'slug'          => 'fe-advanced-search',
            'plugin'        => 'fe-advanced-search/fe-advanced-search.php',
        ...
        $transient->no_update['fe-advanced-search/fe-advanced-search.php'] = $item;
    }
