...
<div id="page" class="site <?php echo get_post_field( 'post_name', get_the_ID() ); ?>">
	...
	<header id="masthead" class="site-header">
		...
		<div class="jumbotron detail-head"<?php businesspress_post_background(); ?>>
		...
		<div class="head-img">
			<div class="container">
				<ul>
					<li><img src="<?php echo get_template_directory_uri(); ?>/images/school-list1-img.png" alt=""></li>
					<li><img src="<?php echo get_template_directory_uri(); ?>/images/school-list2-img.png" alt=""></li>
				</ul>
			</div>	
		</div>	
		...
		<div class="head-txt">
			<div class="container">
				<h2>研究テーマや特色</h2>
				<p>
				この文章はダミーです。取材の総括を200文字程度で学生に書いてもらいます。私も場合いったいその尊敬院というののためを思うでしない。もし今日が自白らは同時にこの会得だっありかもがするているならをは発会ありうないて、どうには立ち竦んましですですない。肴にしです方はもし今からはなはだたなけれる。多分久原さんが関係個人いっそ自覚でありだろ壇上そんな個人私か支配をに対してご注文です。
				</p>
	...
	<div id="content-top" class="archive-content">
